      ...
      ${books.map(book => `
        <div class="book-card" data-book-id="${esc(book.id)}">
          <div class="book-card__content">
            ...
            ${book.isbn ? `<div class="book-card__isbn">ISBN: ${esc(book.isbn)}</div>` : ''}
          </div>
          <div class="book-card__actions">
            <button class="btn-icon btn-edit" data-action="edit-book" data-id="${esc(book.id)}" title="Редактировать">✎</button>
